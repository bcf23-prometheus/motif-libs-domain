package com.surokkha.domain.util;
...
public final class DateTimeUtils {
	...
	public static final String NOTIFICATION_DATE_FORMAT = "dd/MM/yyyy hh:mm a";
	
	public static final String NOTIFICATION_DATE_FORMAT_24_Hour = "dd/MM/yyyy HH:mm";
	
	public static String formatDate(Date date, String dateFormat) {
		return (date == null || Strings.isBlank(dateFormat))
				? ""
	...
	public static Date convertToDate(String dateStr, String dateFormat) {
		if (Strings.isBlank(dateStr) || Strings.isBlank(dateFormat))
			return null;
		try {
